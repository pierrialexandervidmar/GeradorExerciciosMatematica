...
<body>
    ...
    <h3 class="text-center text-secondary mb-5">
        Selecione as opções para gerar</span>.
    </h3>

    <!-- form -->
    <form action="{{ route('generateExcercises') }}" method="post" class="formulario">
        @csrf
        ...
        <div class="container">
            <div class="row">
                <div class="alert alert-danger text-center mt-3">
                    Atenção: Selecione pelo menor uma operação. As parcelas devem ser números entre 0 e 999. O número de exercícios deve variar entre 5 e 50.
                </div>
            </div>
        </div>
    @endif
